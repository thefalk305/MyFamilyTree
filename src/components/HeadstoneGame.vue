...
var incorrect = ref(false);
myScore.value = parseInt(localStorage.getItem("totalScore"));
...
function blur(e) {
  ...
  if (blurString != "none") {
    var blurValue = parseInt(blurString.match(regex)[0]);
  ...
  if (selected.value === "") {
    ...
    if (selected.value === props.stone.split(".")[0]) {
      if (!correct.value) {
        ...
        localStorage.setItem("totalScore", tempScore + points.value);
        myScore.value = tempScore + points.value;
        ...
        <div class="modal-header">
          <slot name="header">
            ...
            <div v-if="showAnswers">
              <div v-for="(headstone, index) in headstoneNames">
                <input
                  class="radioBtn"
                  type="radio"
                  name="hstone"
