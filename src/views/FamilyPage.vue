...
pics.value.push("Al Sr Naval Voyages009.jpg");
pics.value.push("Al Sr Naval Voyages010.jpg");
pics.value.push("pic0003.jpg");
pics.value.push("pic0004.jpg");
pics.value.push("pic0005.jpg");
    ...
    <div v-if="show" class="modal-mask">
      <section class="modal-container infopic">
        ...
        <figure class="hdshot" style="top: -16px">
          <a
            :href="require('@/assets/img/face2a.png')"
            data-lightbox="pics000"
            :title="pic"
          >
            <img :src="require('@/assets/img/face2a.png')" alt="photo" />
          </a>
        </figure>
